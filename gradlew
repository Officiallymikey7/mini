...
#
# If you need to change this, copy and edit:
# https://services.gradle.org/distributions/gradle-X.Y.Z-bin.zip
# and then run "gradle wrapper --gradle-version X.Y.Z"
##############################################################################
...
# This is reliable if the file is not removed while the script is running.
